<div class="max-w-lg py-8 px-4">
    <h1 class="text-2xl font-medium mb-4">Create Album</h1>
    @if ($errors->any())
        <div class="mb-4">
    ...
    <form action="{{ route('albums.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" id="title" name="title" placeholder="Enter title" class="mt-1 focus:ring-gray-500 focus:border-gray-500 block w-full sm:text-sm border-gray-300 rounded-md">
        </div>
        <div>
        ...
        <div>
            ...
            <div class="mt-1 flex items-center">
                ...
                <div id="image-preview-container" class="ml-4 relative hidden w-20 h-20">
                    ...
                    <button type="button" id="cancel-preview-btn" class="absolute top-0 right-0 text-white transform translate-x-1/2 -translate-y-1/2 bg-black rounded-full p-1 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        ...
        <div>
            <button type="submit" class="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md text-base font-medium text-white bg-gray-800 hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                Submit
            </button>
        </div>
    </form>
